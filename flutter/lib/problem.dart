...
class _ProblemPageState extends State<ProblemPage> {
  ...
  runCode() async {
    ...
    String uri = '$apiUrl/executor/run';
  ...
  submitCode() async {
    ...
    String uri = '$apiUrl/submit/judge';
    Map<String, String> body = {
      "ACCESS_TOKEN": MY_ACCESS_TOKEN,
      "code": code,
      "inp": '',
  ...
  _ProblemPageState({Map<String, dynamic>? cproblem}) {
    ...
    problemWidgetList.add(Container(
      margin: EdgeInsets.only(top: 10.0),
      child: Column(
        // child: Column(
        children: [
          Text("problem : " + problemcode,
              style: TextStyle(
                fontSize: 20,
              ))
        ],
  ...
  Widget build(BuildContext context) {
    ...
    List<FileEditor> files = [
      FileEditor(name: "hello.cpp", language: "cpp", code: code)
    ];
              ...
              children: [
                Footer(
                    ...
                    padding: EdgeInsets.all(
                        5.0), // Takes EdgeInsetsGeometry with default being EdgeInsets.all(5.0)
                ...
                CodeEditor(
                  ...
                  textEditingController:
                      null, // Provide an optional, custom TextEditingController.
                ),
                Container(
                  child: isSubmitting
                      ? Text('judging ...', style: TextStyle(fontSize: 24))
                      : Text(''),
                ),
                Container(
                  child: isRunning
                ...
                Container(
                  child: isResult
                      ? Text(status,
                          style: TextStyle(fontSize: 24, color: verdictColor))
                      : Text(''),
                ),
                Row(
                  children: [
