...
class _ProblemPageState extends State<ProblemsPage> {
  ...
  retriveProblems() async {
    ...
    String uri = '$apiUrl/problems/getProblems';
    Map<String, dynamic> body = {'problemCriteria': {}};
    ...
    if (decodedResponse['accepted'] == 'yes') {
      ...
      for (Map<String, dynamic> problem in currList) {
        ...
        problemListWidgets.add(Container(
              ...
              children: [
                ...
                isLoading
                    ...
                    : SingleChildScrollView(
                        child: Column(children: problemListWidgets)),
                TextField(
                  enabled: false,
                  maxLines: 20, //or null
                  decoration: InputDecoration(
